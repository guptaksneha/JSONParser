package com.example.android.parserexample;
...
public class MainActivity extends ListActivity {
    ...
    private static final String TAG_STUDENTEMAIL = "email";
    private static final String TAG_ADDRESS = "address";
    private static final String TAG_STUDENT_GENDER = "gender";
    private static final String TAG_STUDENT_PHONE = "phone";
        ...
        if (json != null) {
            try {
                ...
                for (int i = 0; i < students.length(); i++) {
                    ...
                    String email = c.getString(TAG_STUDENTEMAIL);
                    ...
                    student.put(TAG_STUDENTEMAIL, email);
        ...
        protected void onPostExecute(Void requestresult) {
            ...
            * Updating received data from JSON into ListView
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.info_main, new String[]{TAG_STUDENT_NAME, TAG_STUDENTEMAIL,
